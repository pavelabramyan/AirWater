...
const locationsData = {
    'ru': {
        ...
        'Индонезия': {
            ...
            regions: {
                'Джакарта': { humidity: 80, coords: [-6.2088, 106.8456], waterPriceUsd1L: 0.35 },
                'Западная Ява': { humidity: 78, coords: [-6.9175, 107.6191], waterPriceUsd1L: 0.32 },
                'Центральная Ява': { humidity: 78, coords: [-7.1510, 110.1403], waterPriceUsd1L: 0.30 },
                'Восточная Ява': { humidity: 76, coords: [-7.5361, 112.2384], waterPriceUsd1L: 0.32 },
                'Бантен': { humidity: 80, coords: [-6.4058, 106.0640], waterPriceUsd1L: 0.35 },
                'Джокьякарта': { humidity: 78, coords: [-7.7956, 110.3695], waterPriceUsd1L: 0.30 },
                'Бали': { humidity: 78, coords: [-8.4095, 115.1889], waterPriceUsd1L: 0.40 },
                'Западная Нуса-Тенгара': { humidity: 75, coords: [-8.6529, 117.3616], waterPriceUsd1L: 0.35 },
                'Восточная Нуса-Тенгара': { humidity: 70, coords: [-8.6574, 121.0794], waterPriceUsd1L: 0.38 },
                'Западный Калимантан': { humidity: 85, coords: [-0.2787, 111.4752], waterPriceUsd1L: 0.35 },
                'Центральный Калимантан': { humidity: 85, coords: [-1.6815, 113.3824], waterPriceUsd1L: 0.38 },
                'Южный Калимантан': { humidity: 82, coords: [-3.0926, 115.2838], waterPriceUsd1L: 0.35 },
                'Восточный Калимантан': { humidity: 82, coords: [0.5387, 116.4194], waterPriceUsd1L: 0.38 },
                'Северный Калимантан': { humidity: 85, coords: [3.0731, 116.0414], waterPriceUsd1L: 0.40 },
                'Северный Сулавеси': { humidity: 82, coords: [0.6247, 123.9750], waterPriceUsd1L: 0.38 },
                'Центральный Сулавеси': { humidity: 80, coords: [-1.4300, 121.4456], waterPriceUsd1L: 0.35 },
                'Южный Сулавеси': { humidity: 80, coords: [-3.6688, 119.9741], waterPriceUsd1L: 0.32 },
                'Юго-Восточный Сулавеси': { humidity: 82, coords: [-4.1449, 122.1746], waterPriceUsd1L: 0.35 },
                'Горонтало': { humidity: 80, coords: [0.6999, 122.4467], waterPriceUsd1L: 0.35 },
                'Западный Сулавеси': { humidity: 82, coords: [-2.8441, 119.2321], waterPriceUsd1L: 0.35 },
                'Малуку': { humidity: 85, coords: [-3.2385, 130.1453], waterPriceUsd1L: 0.40 },
                ...
                'Аче': { humidity: 82, coords: [4.6951, 96.7494], waterPriceUsd1L: 0.32 },
                'Северная Суматра': { humidity: 82, coords: [2.1154, 99.5451], waterPriceUsd1L: 0.32 },
                'Западная Суматра': { humidity: 82, coords: [-0.7399, 100.8000], waterPriceUsd1L: 0.32 },
                'Риау': { humidity: 85, coords: [0.2933, 101.7068], waterPriceUsd1L: 0.35 },
                'Острова Риау': { humidity: 85, coords: [3.9457, 108.1429], waterPriceUsd1L: 0.38 },
                'Джамби': { humidity: 82, coords: [-1.4852, 102.4381], waterPriceUsd1L: 0.32 },
                'Южная Суматра': { humidity: 82, coords: [-3.3194, 104.9147], waterPriceUsd1L: 0.32 },
                'Бангка-Белитунг': { humidity: 85, coords: [-2.7411, 106.4406], waterPriceUsd1L: 0.38 },
                'Бенкулу': { humidity: 82, coords: [-3.5778, 102.3464], waterPriceUsd1L: 0.32 },
                'Лампунг': { humidity: 80, coords: [-4.5586, 105.4068], waterPriceUsd1L: 0.32 },
            }
        },
        'Иордания': {
    ...
    'en': {
        ...
        'Indonesia': {
            coords: [-0.7893, 113.9213],
            regions: {
                'Jakarta': { humidity: 80, coords: [-6.2088, 106.8456], waterPriceUsd1L: 0.35 },
                'West Java': { humidity: 78, coords: [-6.9175, 107.6191], waterPriceUsd1L: 0.32 },
                'Central Java': { humidity: 78, coords: [-7.1510, 110.1403], waterPriceUsd1L: 0.30 },
                'East Java': { humidity: 76, coords: [-7.5361, 112.2384], waterPriceUsd1L: 0.32 },
                'Banten': { humidity: 80, coords: [-6.4058, 106.0640], waterPriceUsd1L: 0.35 },
                'Yogyakarta': { humidity: 78, coords: [-7.7956, 110.3695], waterPriceUsd1L: 0.30 },
                'Bali': { humidity: 78, coords: [-8.4095, 115.1889], waterPriceUsd1L: 0.40 },
                'West Nusa Tenggara': { humidity: 75, coords: [-8.6529, 117.3616], waterPriceUsd1L: 0.35 },
                'East Nusa Tenggara': { humidity: 70, coords: [-8.6574, 121.0794], waterPriceUsd1L: 0.38 },
                'West Kalimantan': { humidity: 85, coords: [-0.2787, 111.4752], waterPriceUsd1L: 0.35 },
                'Central Kalimantan': { humidity: 85, coords: [-1.6815, 113.3824], waterPriceUsd1L: 0.38 },
                'South Kalimantan': { humidity: 82, coords: [-3.0926, 115.2838], waterPriceUsd1L: 0.35 },
                'East Kalimantan': { humidity: 82, coords: [0.5387, 116.4194], waterPriceUsd1L: 0.38 },
                'North Kalimantan': { humidity: 85, coords: [3.0731, 116.0414], waterPriceUsd1L: 0.40 },
                'North Sulawesi': { humidity: 82, coords: [0.6247, 123.9750], waterPriceUsd1L: 0.38 },
                'Central Sulawesi': { humidity: 80, coords: [-1.4300, 121.4456], waterPriceUsd1L: 0.35 },
                'South Sulawesi': { humidity: 80, coords: [-3.6688, 119.9741], waterPriceUsd1L: 0.32 },
                'Southeast Sulawesi': { humidity: 82, coords: [-4.1449, 122.1746], waterPriceUsd1L: 0.35 },
                'Gorontalo': { humidity: 80, coords: [0.6999, 122.4467], waterPriceUsd1L: 0.35 },
                'West Sulawesi': { humidity: 82, coords: [-2.8441, 119.2321], waterPriceUsd1L: 0.35 },
                'Maluku': { humidity: 85, coords: [-3.2385, 130.1453], waterPriceUsd1L: 0.40 },
                ...
                'Aceh': { humidity: 82, coords: [4.6951, 96.7494], waterPriceUsd1L: 0.32 },
                'North Sumatra': { humidity: 82, coords: [2.1154, 99.5451], waterPriceUsd1L: 0.32 },
                'West Sumatra': { humidity: 82, coords: [-0.7399, 100.8000], waterPriceUsd1L: 0.32 },
                'Riau': { humidity: 85, coords: [0.2933, 101.7068], waterPriceUsd1L: 0.35 },
                'Riau Islands': { humidity: 85, coords: [3.9457, 108.1429], waterPriceUsd1L: 0.38 },
                'Jambi': { humidity: 82, coords: [-1.4852, 102.4381], waterPriceUsd1L: 0.32 },
                'South Sumatra': { humidity: 82, coords: [-3.3194, 104.9147], waterPriceUsd1L: 0.32 },
                'Bangka Belitung Islands': { humidity: 85, coords: [-2.7411, 106.4406], waterPriceUsd1L: 0.38 },
                'Bengkulu': { humidity: 82, coords: [-3.5778, 102.3464], waterPriceUsd1L: 0.32 },
                'Lampung': { humidity: 80, coords: [-4.5586, 105.4068], waterPriceUsd1L: 0.32 },
            }
        },
        'Iraq': {
            coords: [33.2232, 43.6793],
    ...
    'zh': {
        ...
        '印度尼西亚': {
            coords: [-0.7893, 113.9213],
            regions: {
                '雅加达': { humidity: 80, coords: [-6.2088, 106.8456], waterPriceUsd1L: 0.35 },
                '西爪哇': { humidity: 78, coords: [-6.9175, 107.6191], waterPriceUsd1L: 0.32 },
                '中爪哇': { humidity: 78, coords: [-7.1510, 110.1403], waterPriceUsd1L: 0.30 },
                '东爪哇': { humidity: 76, coords: [-7.5361, 112.2384], waterPriceUsd1L: 0.32 },
                '万丹': { humidity: 80, coords: [-6.4058, 106.0640], waterPriceUsd1L: 0.35 },
                '日惹': { humidity: 78, coords: [-7.7956, 110.3695], waterPriceUsd1L: 0.30 },
                '巴厘岛': { humidity: 78, coords: [-8.4095, 115.1889], waterPriceUsd1L: 0.40 },
                '西努沙登加拉': { humidity: 75, coords: [-8.6529, 117.3616], waterPriceUsd1L: 0.35 },
                '东努沙登加拉': { humidity: 70, coords: [-8.6574, 121.0794], waterPriceUsd1L: 0.38 },
                '西加里曼丹': { humidity: 85, coords: [-0.2787, 111.4752], waterPriceUsd1L: 0.35 },
                '中加里曼丹': { humidity: 85, coords: [-1.6815, 113.3824], waterPriceUsd1L: 0.38 },
                '南加里曼丹': { humidity: 82, coords: [-3.0926, 115.2838], waterPriceUsd1L: 0.35 },
                '东加里曼丹': { humidity: 82, coords: [0.5387, 116.4194], waterPriceUsd1L: 0.38 },
                '北加里曼丹': { humidity: 85, coords: [3.0731, 116.0414], waterPriceUsd1L: 0.40 },
                '北苏拉威西': { humidity: 82, coords: [0.6247, 123.9750], waterPriceUsd1L: 0.38 },
                '中苏拉威西': { humidity: 80, coords: [-1.4300, 121.4456], waterPriceUsd1L: 0.35 },
                '南苏拉威西': { humidity: 80, coords: [-3.6688, 119.9741], waterPriceUsd1L: 0.32 },
                '东南苏拉威西': { humidity: 82, coords: [-4.1449, 122.1746], waterPriceUsd1L: 0.35 },
                '哥伦打洛': { humidity: 80, coords: [0.6999, 122.4467], waterPriceUsd1L: 0.35 },
                '西苏拉威西': { humidity: 82, coords: [-2.8441, 119.2321], waterPriceUsd1L: 0.35 },
                '马鲁古': { humidity: 85, coords: [-3.2385, 130.1453], waterPriceUsd1L: 0.40 },
                ...
                '亚齐': { humidity: 82, coords: [4.6951, 96.7494], waterPriceUsd1L: 0.32 },
                '北苏门答腊': { humidity: 82, coords: [2.1154, 99.5451], waterPriceUsd1L: 0.32 },
                '西苏门答腊': { humidity: 82, coords: [-0.7399, 100.8000], waterPriceUsd1L: 0.32 },
                '廖内': { humidity: 85, coords: [0.2933, 101.7068], waterPriceUsd1L: 0.35 },
                '廖内群岛': { humidity: 85, coords: [3.9457, 108.1429], waterPriceUsd1L: 0.38 },
                '占碑': { humidity: 82, coords: [-1.4852, 102.4381], waterPriceUsd1L: 0.32 },
                '南苏门答腊': { humidity: 82, coords: [-3.3194, 104.9147], waterPriceUsd1L: 0.32 },
                '邦加-勿里洞群岛': { humidity: 85, coords: [-2.7411, 106.4406], waterPriceUsd1L: 0.38 },
                '明古鲁': { humidity: 82, coords: [-3.5778, 102.3464], waterPriceUsd1L: 0.32 },
                '楠榜': { humidity: 80, coords: [-4.5586, 105.4068], waterPriceUsd1L: 0.32 },
            }
        },
        '危地马拉': {
            coords: [15.7835, -90.2308],
    ...
    'es': {
        ...
        'Indonesia': {
            coords: [-0.7893, 113.9213],
            regions: {
                'Yakarta': { humidity: 80, coords: [-6.2088, 106.8456], waterPriceUsd1L: 0.35 },
                'Java Occidental': { humidity: 78, coords: [-6.9175, 107.6191], waterPriceUsd1L: 0.32 },
                'Java Central': { humidity: 78, coords: [-7.1510, 110.1403], waterPriceUsd1L: 0.30 },
                'Java Oriental': { humidity: 76, coords: [-7.5361, 112.2384], waterPriceUsd1L: 0.32 },
                'Bantén': { humidity: 80, coords: [-6.4058, 106.0640], waterPriceUsd1L: 0.35 },
                'Yogyakarta': { humidity: 78, coords: [-7.7956, 110.3695], waterPriceUsd1L: 0.30 },
                'Bali': { humidity: 78, coords: [-8.4095, 115.1889], waterPriceUsd1L: 0.40 },
                'Nusatenggara Occidental': { humidity: 75, coords: [-8.6529, 117.3616], waterPriceUsd1L: 0.35 },
                'Nusatenggara Oriental': { humidity: 70, coords: [-8.6574, 121.0794], waterPriceUsd1L: 0.38 },
                'Kalimantan Occidental': { humidity: 85, coords: [-0.2787, 111.4752], waterPriceUsd1L: 0.35 },
                'Kalimantan Central': { humidity: 85, coords: [-1.6815, 113.3824], waterPriceUsd1L: 0.38 },
                'Kalimantan Meridional': { humidity: 82, coords: [-3.0926, 115.2838], waterPriceUsd1L: 0.35 },
                'Kalimantan Oriental': { humidity: 82, coords: [0.5387, 116.4194], waterPriceUsd1L: 0.38 },
                'Kalimantan Septentrional': { humidity: 85, coords: [3.0731, 116.0414], waterPriceUsd1L: 0.40 },
                'Sulawesi Septentrional': { humidity: 82, coords: [0.6247, 123.9750], waterPriceUsd1L: 0.38 },
                'Sulawesi Central': { humidity: 80, coords: [-1.4300, 121.4456], waterPriceUsd1L: 0.35 },
                'Sulawesi Meridional': { humidity: 80, coords: [-3.6688, 119.9741], waterPriceUsd1L: 0.32 },
                'Sulawesi Suroriental': { humidity: 82, coords: [-4.1449, 122.1746], waterPriceUsd1L: 0.35 },
                'Gorontalo': { humidity: 80, coords: [0.6999, 122.4467], waterPriceUsd1L: 0.35 },
                'Sulawesi Occidental': { humidity: 82, coords: [-2.8441, 119.2321], waterPriceUsd1L: 0.35 },
                'Molucas': { humidity: 85, coords: [-3.2385, 130.1453], waterPriceUsd1L: 0.40 },
                ...
                'Aceh': { humidity: 82, coords: [4.6951, 96.7494], waterPriceUsd1L: 0.32 },
                'Sumatra Septentrional': { humidity: 82, coords: [2.1154, 99.5451], waterPriceUsd1L: 0.32 },
                'Sumatra Occidental': { humidity: 82, coords: [-0.7399, 100.8000], waterPriceUsd1L: 0.32 },
                'Riau': { humidity: 85, coords: [0.2933, 101.7068], waterPriceUsd1L: 0.35 },
                'Islas Riau': { humidity: 85, coords: [3.9457, 108.1429], waterPriceUsd1L: 0.38 },
                'Jambi': { humidity: 82, coords: [-1.4852, 102.4381], waterPriceUsd1L: 0.32 },
                'Sumatra Meridional': { humidity: 82, coords: [-3.3194, 104.9147], waterPriceUsd1L: 0.32 },
                'Islas Bangka Belitung': { humidity: 85, coords: [-2.7411, 106.4406], waterPriceUsd1L: 0.38 },
                'Bengkulu': { humidity: 82, coords: [-3.5778, 102.3464], waterPriceUsd1L: 0.32 },
                'Lampung': { humidity: 80, coords: [-4.5586, 105.4068], waterPriceUsd1L: 0.32 },
            }
        },
